...
:::tip
此页面上的所有指令，在输入前请将要输入的内容根据实际情况替换。
:::

进入游戏后，请注意聊天框提示的内容：

<code><font color="#555555">[</font><font color="#FFAA00">玩家系统</font><font color="#555555">]</font> <font color="#FF5555">初次登录，请注册。输入“/reg 设置密码 再输入一次密码”以注册</font></code>

按照提示输入指令，即可完成注册。注："设置密码"和"再输入一次密码"均要替换为你要设置的密码。
:::tip
密码要求：不少于5个字符，不多于30个字符，只可使用字母，数字，下划线作为密码组成元素。
:::
...
按照提示输入指令，即可完成登录。注：”密码“为你前文设置的密码
...
根据提示设置邮箱即可，操作与前文同理。一个邮箱只可绑定一个白名单账户。
